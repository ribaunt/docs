...
description: "Vollständige Referenz für alle HTML-Attribute und React-Props von ribaunt-widget: Endpunkte, Auto-Verify, Timeout, Disabled-Zustand und Challenge-Antwortformate."
---
