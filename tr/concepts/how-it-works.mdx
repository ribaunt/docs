...
<Steps>
  ...
  <Step title="Sunucu çözümleri doğrular">
    ...
    Yalnızca tüm kontroller geçerse `verifySolution()` `{ valid: true }` döndürür.
...
| --- | --- | --- |
| `createChallenge({ difficulty: 4, amount: 4, ttlSeconds: 30 })` | Milisaniyeler | Hızlı / arka plan kontrolleri |
| `createChallenge({ difficulty: 5, amount: 4, ttlSeconds: 60 })` | ~1 saniye | Orta / form gönderimi |
| `createChallenge({ difficulty: 5, amount: 8, ttlSeconds: 120 })` | ~2 saniye | Yüksek / hassas işlemler |
